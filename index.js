...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        game.setAttribute("data-title", games[i].name);
...
const singular = unfundedGamesCount === 1;
const unfundedString = 
    `A total of <strong>$${totalRaised.toLocaleString()}</strong> has been raised for ${GAMES_JSON.length} games. 
    Currently, ${unfundedGamesCount} game${singular ? "" : "s"} remain${singular ? "s" : ""} unfunded. 
    We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const description = document.createElement("p");
description.innerHTML = unfundedString;
...
// Customizations:
// 1. Add a search bar to filter games by name
// 2. Adjust CSS for style and contrast
